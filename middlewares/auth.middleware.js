    ...
    if (!req.headers.auth) {
        ...
        if (decoded.id) {
            ...
            if (restraunt) {
                ...
                req.restaurant = { id: decoded.id, role: restraunt.role, restrauntId: decoded_id, email: restaurant.Email, name: restraunt.Business_name, address: restraunt.Office_address, username: restraunt.Username }
